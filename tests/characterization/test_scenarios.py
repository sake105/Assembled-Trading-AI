...
def test_scenario_rates_2022_negative_return():
    ...
    assert total_return < 0.20, f"Suspiciously high return in rates scenario: {total_return:.2%}"
...
def test_scenario_calm_2017_positive_return():
    ...
    assert total_return > -0.20, f"Unexpectedly bad return in calm scenario: {total_return:.2%}"
