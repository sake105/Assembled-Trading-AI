...
class TestCertification:
    def test_runner_basic(self):
        ...
        pytest.importorskip("src.assembled_core.ops.certification")
...
class TestStrategyDiscovery:
    ...
    def test_basic_discovery(self):
        ...
        pytest.importorskip("src.assembled_core.strategies.strategy_discovery")
...
class TestDataSourceCascade:
    def test_primary_success(self):
        ...
        pytest.importorskip("src.assembled_core.ops.self_healing")
    ...
    def test_all_fail(self):
        ...
        cascade = DataSourceCascade()
        cascade.register_source(
            "s1", lambda: (_ for _ in ()).throw(RuntimeError("fail"))
        )
