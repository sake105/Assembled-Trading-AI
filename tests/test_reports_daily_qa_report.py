...
def synthetic_equity_negative() -> pd.DataFrame:
    ...
    return pd.DataFrame(
        {"timestamp": dates, "equity": equity_values[:-1], "daily_return": returns}
    )
...
def test_generate_qa_report_creates_file(
...
def test_generate_qa_report_contains_metrics(
    tmp_path, sample_metrics_positive, sample_gate_result_ok
):
...
def test_generate_qa_report_contains_qa_gates(
    tmp_path, sample_metrics_positive, sample_gate_result_ok
):
...
def test_generate_qa_report_qa_status_block(
    tmp_path, sample_metrics_negative, sample_gate_result_block
):
...
def test_generate_qa_report_contains_equity_curve(
    tmp_path, sample_metrics_positive, sample_gate_result_ok
):
...
def test_generate_qa_report_contains_data_status(
    tmp_path, sample_metrics_positive, sample_gate_result_ok
):
...
def test_generate_qa_report_contains_config(
    tmp_path, sample_metrics_positive, sample_gate_result_ok
):
...
def test_generate_qa_report_from_files(
    tmp_path, synthetic_equity_positive, synthetic_trades
):
...
def test_generate_qa_report_gate_table_format(
    tmp_path, sample_metrics_positive, sample_gate_result_ok
):
...
def test_generate_qa_report_period_info(
    tmp_path, sample_metrics_positive, sample_gate_result_ok
):
