...
class TestRoundTrip:
    def test_ev_to_intel_to_ev_preserves_key_fields(self):
        ...
        from src.assembled_core.events.news.compat import events_to_intel, intel_to_events
    ...
    def test_intel_to_ev_to_intel_preserves_key_fields(self):
        ...
        from src.assembled_core.events.news.compat import intel_to_events, events_to_intel
    ...
    def test_published_at_round_trip_within_second(self):
        ...
        assert "2024-06-01" in recovered.published_utc or "2024-06" in recovered.published_utc
