...
def test_insider_factors_respect_disclosure_date(
    ...
    aapl_before = factors_before[factors_before["symbol"] == "AAPL"]
    aapl_jan_11 = aapl_before[
        aapl_before["timestamp"] == pd.Timestamp("2024-01-11", tz="UTC")
    ]
    ...
    msft_jan_11 = msft_before[
        msft_before["timestamp"] == pd.Timestamp("2024-01-11", tz="UTC")
    ]
    ...
    aapl_on_b = factors_on_b_disclosure[factors_on_b_disclosure["symbol"] == "AAPL"]
    aapl_jan_12 = aapl_on_b[
        aapl_on_b["timestamp"] == pd.Timestamp("2024-01-12", tz="UTC")
    ]
...
def test_earnings_factors_no_lookahead_bias(
    ...
    aapl_before = factors_before_disclosure[
        factors_before_disclosure["symbol"] == "AAPL"
    ]
    ...
    if common_dates.any():
        ...
        before_vals = aapl_before[
            aapl_before["timestamp"].isin(aapl_baseline[common_dates]["timestamp"])
...
def test_earnings_factors_in_backtest_scenario(
    ...
    for current_date in trading_dates:
        ...
        aapl_factors = factors[
            (factors["symbol"] == "AAPL") & (factors["timestamp"] == current_date)
        ]
        ...
        msft_factors = factors[
            (factors["symbol"] == "MSFT") & (factors["timestamp"] == current_date)
        ]
