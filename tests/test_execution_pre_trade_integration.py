...
class TestOrderFlowWithRiskControls:
    ...
    def test_order_flow_respects_pre_trade_checks(self, sample_target_positions, sample_prices, tmp_path: Path):
    ...
    def test_order_flow_respects_kill_switch(self, sample_target_positions, sample_prices, tmp_path: Path):
    ...
    def test_order_flow_passes_valid_orders(self, sample_target_positions, sample_prices, tmp_path: Path):
