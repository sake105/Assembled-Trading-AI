...
from src.assembled_core.utils.atomic_io import atomic_write_json, atomic_write_json_with_retry
...
class TestAtomicWriteJson:
    ...
    def test_crash_during_replace_raises_and_leaves_no_partial_file(self, tmp_path, monkeypatch):
...
class TestAtomicWriteJsonIntegration:
    ...
    def test_factor_store_manifest_uses_atomic_write(self, tmp_path, monkeypatch):
        ...
        panel_dir.mkdir()
        _write_manifest(panel_dir, df, factor_group="test", freq="1d", universe_key="US")
