...
class TestPolymarketSource:
    def test_module_importable(self):
        from assembled_core.data.sources.polymarket_source import GEO_KEYWORDS
...
class TestNewsRAG:
    ...
    def test_ingest_and_query_memory_store(self):
        ...
        rag.ingest(
            "Strong jobs report surprises", "SPY", "2022-07-08", outcome_return=0.02
        )
    ...
    def test_bearish_outcome_predicts_bearish(self):
        ...
        for _ in range(5):
            rag.ingest(
                "Massive negative event", "SPY", "2024-01-01", outcome_return=-0.05
            )
...
class TestDifferentialPrivacy:
    ...
    def test_gaussian_mechanism_adds_noise(self):
        ...
        result = gaussian_mechanism(
            10.0, sensitivity=1.0, epsilon=1.0, delta=1e-5, rng=rng
        )
...
class TestOrderBookImbalance:
    ...
    def test_spread_calculation(self):
        ...
        assert feat.spread_bps == pytest.approx(
            0.2 / 100.1 * 10_000, abs=0.5
        )  # ~20 bps
...
class TestBayesianConfidenceT15:
    ...
    def test_t15_reliability_between_t1_and_t2(self):
        ...
        assert (
            ...
            < SOURCE_RELIABILITY["T1.5"]
            < SOURCE_RELIABILITY["T1"]
        )
    ...
    def test_t15_fpr_between_t1_and_t2(self):
        ...
        assert (
            ...
            < FALSE_POSITIVE_RATE["T1.5"]
            < FALSE_POSITIVE_RATE["T2"]
        )
