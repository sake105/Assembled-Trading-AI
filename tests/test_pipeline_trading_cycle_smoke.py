    ...
    prices = pd.DataFrame(
        {
            ...
            + [200.0 + i * 0.3 for i in range(20)],
            "high": [101.0 + i * 0.5 for i in range(20)]
            + [201.0 + i * 0.3 for i in range(20)],
            "low": [99.0 + i * 0.5 for i in range(20)]
            + [199.0 + i * 0.3 for i in range(20)],
            "open": [100.5 + i * 0.5 for i in range(20)]
            + [200.5 + i * 0.3 for i in range(20)],
            "volume": [1000000.0] * 40,
        }
    )
    ...
    prices = pd.DataFrame(
        {
            ...
            + [200.0 + i * 0.3 for i in range(30)],
            "high": [101.0 + i * 0.5 for i in range(30)]
            + [201.0 + i * 0.3 for i in range(30)],
            "low": [99.0 + i * 0.5 for i in range(30)]
            + [199.0 + i * 0.3 for i in range(30)],
            "open": [100.5 + i * 0.5 for i in range(30)]
            + [200.5 + i * 0.3 for i in range(30)],
            "volume": [1000000.0] * 60,
        }
    )
