    ...
    timings_data = {
        ...
        "steps": {
            "load_data": {
                ...
                "end_ts": "2024-01-01T12:00:00",
            },
            "build_factors": {
                "duration_ms": 200.0,
                "start_ts": "2024-01-01T12:00:01",
                "end_ts": "2024-01-01T12:00:01",
            },
            "signals": {
                "duration_ms": 50.0,
                "start_ts": "2024-01-01T12:00:02",
                "end_ts": "2024-01-01T12:00:02",
            },
        },
        "summary": {
            "total_steps": 3,
...
def test_generate_performance_profile_report_with_data(
    fake_profiles_dir: Path, tmp_path: Path, monkeypatch: pytest.MonkeyPatch
) -> None:
