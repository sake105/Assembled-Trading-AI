...
def test_run_daily_broker_snapshot_args_help():
    ...
    assert hasattr(run_daily_module, "run_daily_eod"), "run_daily_eod() function should exist"
    ...
    assert "broker_snapshot_policy" in params, "broker_snapshot_policy parameter should exist"
    assert "write_broker_snapshot" in params, "write_broker_snapshot parameter should exist"
    assert "broker_snapshot_run_id" in params, "broker_snapshot_run_id parameter should exist"
    assert "broker_snapshot_file" in params, "broker_snapshot_file parameter should exist"
    assert "broker_snapshot_date" in params, "broker_snapshot_date parameter should exist"
