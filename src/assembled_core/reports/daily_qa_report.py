...
def _build_report_content(
    ...
    if gate_result is not None:
        ...
        if hasattr(gate_result, "passed_gates") and hasattr(gate_result, "warning_gates") and hasattr(gate_result, "blocked_gates"):
        ...
        for gate in gate_result.gate_results:
            ...
            reason_short = gate.reason[:60] + "..." if len(gate.reason) > 60 else gate.reason
    ...
    if equity_curve_path is not None:
        ...
        lines.append("")
        lines.append("> **Note:** To visualize the equity curve, load the CSV file in your preferred tool (Excel, Python, etc.)")
        lines.append("")
        lines.append("---")
        lines.append("")
