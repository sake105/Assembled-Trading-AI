...
def build_multifactor_signal(
    ...
    for factor_cfg in available_factors:
        ...
        if bundle.options.winsorize:
            ...
            logger.debug(f"Winsorizing {factor_name} with limits [{lower_q}, {upper_q}]")
    ...
    meta = {
        ...
        "options_applied": {
            ...
            "winsorize_limits": bundle.options.winsorize_limits if bundle.options.winsorize else None,
