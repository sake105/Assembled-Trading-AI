...
INVERSE_ETF_PROFILES: dict[str, InverseETFProfile] = {
    ...
    "SH": InverseETFProfile(
        ...
        leverage=-1.0,
        benchmark="S&P500",
        avg_daily_volume_k=5000,
        expense_ratio_bps=88,
        bid_ask_spread_bps=2,
        daily_vol_decay_factor=0.0,
        liquidity_tier="high",
    ),
    "PSQ": InverseETFProfile(
        ...
        leverage=-1.0,
        benchmark="NASDAQ100",
        avg_daily_volume_k=3000,
        expense_ratio_bps=95,
    ...
    "SEF": InverseETFProfile(
        ...
        sector="FINANCE",
        leverage=-1.0,
        benchmark="DJ US Financials",
        avg_daily_volume_k=200,
        expense_ratio_bps=95,
    ...
    "SSG": InverseETFProfile(
        ...
        sector="SEMIS",
        leverage=-2.0,
        benchmark="DJ US Semiconductors",
        avg_daily_volume_k=150,
        expense_ratio_bps=95,
        bid_ask_spread_bps=15,
        daily_vol_decay_factor=0.35,
        liquidity_tier="low",
    ),
    "MYY": InverseETFProfile(
        ...
        sector="MID_CAP",
        leverage=-1.0,
        benchmark="S&P MidCap400",
        avg_daily_volume_k=100,
        expense_ratio_bps=95,
    ...
    "REK": InverseETFProfile(
        ...
        sector="REAL_ESTATE",
        leverage=-1.0,
        benchmark="DJ US Real Estate",
        avg_daily_volume_k=80,
        expense_ratio_bps=95,
        bid_ask_spread_bps=12,
        daily_vol_decay_factor=0.0,
        liquidity_tier="low",
    ),
    "DDG": InverseETFProfile(
        ...
        sector="ENERGY",
        leverage=-1.0,
        benchmark="DJ US Oil & Gas",
        avg_daily_volume_k=60,
        expense_ratio_bps=95,
        bid_ask_spread_bps=15,
        daily_vol_decay_factor=0.0,
        liquidity_tier="low",
    ...
    "VIXY": InverseETFProfile(
        ...
        sector="VOL",
        leverage=1.0,
        benchmark="VIX Futures",
        avg_daily_volume_k=5000,
        expense_ratio_bps=85,
        bid_ask_spread_bps=5,
        daily_vol_decay_factor=0.65,
        liquidity_tier="high",
    ),
}
...
class InverseETFSelector:
    ...
    def select_best_short_instrument(
        ...
        """
        candidates = SECTOR_INSTRUMENT_CANDIDATES.get(
            sector, SECTOR_INSTRUMENT_CANDIDATES["BROAD"]
        )
        ...
        for symbol in candidates:
            ...
            if profile.avg_daily_volume_k < liquidity_min_k:
                logger.debug(
                    "[InverseETFSelector] %s skipped: low volume %dk",
                    symbol,
                    profile.avg_daily_volume_k,
                )
                continue
            ...
            if holding_period_days > 5 and profile.daily_vol_decay_factor > 0.1:
                logger.info(
                    ...
                    symbol,
                    profile.daily_vol_decay_factor * 100,
                    holding_period_days,
                )
    ...
    def rank_instruments_by_efficiency(
        ...
        for symbol in candidates:
            ...
            # Costs
            annual_cost = (
                profile.expense_ratio_bps + profile.bid_ask_spread_bps
            ) / 10000
