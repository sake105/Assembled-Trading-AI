...
FEATURE_REGISTRY: dict[str, dict[str, Any]] = {
    ...
    "alt_news_sentiment_30d_v1": {
        "description": "News sentiment (30-day rolling mean)",
        "inputs": ["news_events"],
        "version": 1,
        "layer": "alt",
        "namespace": "alt",
    },
    "alt_nlp_sentiment_mean_5d_v1": {
        "description": "NLP (FinBERT) sentiment mean (5-day rolling)",
        "inputs": ["news_events", "headline"],
        "version": 1,
        "layer": "alt",
        "namespace": "alt",
    },
    "alt_nlp_sentiment_mean_20d_v1": {
        "description": "NLP (FinBERT) sentiment mean (20-day rolling)",
        "inputs": ["news_events", "headline"],
        "version": 1,
        "layer": "alt",
        "namespace": "alt",
    },
    "alt_nlp_sentiment_momentum_5d_v1": {
        "description": "NLP sentiment momentum (5d mean - 20d mean)",
        "inputs": ["news_events", "headline"],
        "version": 1,
        "layer": "alt",
        "namespace": "alt",
    },
    "alt_nlp_sentiment_dispersion_20d_v1": {
        "description": "NLP sentiment dispersion (20-day rolling std)",
        "inputs": ["news_events", "headline"],
        "version": 1,
        "layer": "alt",
        "namespace": "alt",
