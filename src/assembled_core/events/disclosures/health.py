"""Compute DisclosuresHealth from counts and failures."""
...
from .models import DisclosuresHealth, DisclosuresStatus
...
def compute_health(
    ...
    *,
    ...
    """Compute DisclosuresHealth (OK / DEGRADED / ERROR)."""
