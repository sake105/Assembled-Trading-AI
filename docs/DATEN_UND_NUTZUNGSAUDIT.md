...
| 6.4 | Toter-Code-Archivierung (~40 Waisen) | ◐ TRANCHE 1 ERLEDIGT (2026-08-17: 9 Module + 3 dedizierte Tests + 2 leere Verzeichnisse nach archive/orphaned_code_2026-08-17/, Kriterium 0 Referenzen + keine Sammeltest-Bindung; Collection sauber (0 Errors; 0 Collection-Errors (Zahl interpreterabhaengig, .venv Py3.11: 9.266, Messung 2026-08-17 nach Tranche-2-Chirurgie + 3 Review-Delta-Tests)). TRANCHE 2 ERLEDIGT (2026-08-17: 16 weitere Module + 2 dedizierte Testdateien archiviert nach Testdatei-Chirurgie an 6 Sammel-Testdateien; newsapi-Reexport aus data/sources/__init__ entfernt). REST OFFEN: 9 Kandidaten mit Referenz-Ketten — Details im Archiv-README) |
