...
def main():
    ...
    ap.add_argument("--commission-bps", type=float, default=default_costs.commission_bps,
                    help=f"Commission in basis points (default: {default_costs.commission_bps} from cost model)")
    ap.add_argument("--spread-w", type=float, default=default_costs.spread_w,
                    help=f"Spread weight (default: {default_costs.spread_w} from cost model)")
    ap.add_argument("--impact-w", type=float, default=default_costs.impact_w,
