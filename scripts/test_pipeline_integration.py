...
def test_data_loading():
    ...
    # Set local data root
    local_data_root = Path(r"F:\Python_Projekt\Aktiengerüst\datensammlungen\altdaten\stand 3-12-2025")
...
def test_factor_calculation():
    ...
    try:
        ...
        print(f"  Factor columns: {[c for c in df_factors.columns if c not in df.columns][:5]}...")
        print()
...
def main():
    ...
    try:
        # Test 1: Data loading
        df1 = test_data_loading()
        
        # Test 2: Multiple symbols
        df2 = test_multiple_symbols()
        
        # Test 3: Factor calculation
        df3 = test_factor_calculation()
