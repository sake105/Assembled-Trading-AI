...
def check_report_files(factor_set: str, horizon_days: int, freq: str, output_dir: Path | None = None) -> dict[str, bool]:
...
def main() -> int:
    ...
    if not args.skip_test_1:
        ...
        print("=" * 80)
        print(f"Universe: config/macro_world_etfs_tickers.txt")
        print(f"Factor-Set: core")
        print(f"Date Range: 2010-01-01 to 2025-12-03")
        print()
        ...
        if exit_code == 0:
            print("✅ Test 1 PASSED")
            print(f"   Reports generated: {sum(report_files.values())}/{len(report_files)}")
    ...
    if not args.skip_test_2:
        ...
        print("=" * 80)
        print(f"Universe: config/universe_ai_tech_tickers.txt")
        print(f"Factor-Set: core+alt")
        print(f"Date Range: 2015-01-01 to 2025-12-03")
        print()
    ...
    if not args.skip_test_3:
        ...
        print("=" * 80)
        print(f"Universe: config/universe_ai_tech_tickers.txt")
        print(f"Factor-Set: core+alt_full")
        print(f"Date Range: 2015-01-01 to 2025-12-03")
        print()
        print("⚠️  Note: This test requires alt-data files:")
        print("   - output/altdata/events_earnings.parquet")
        ...
        print("   If missing, the test will continue but without those alt-data factors.")
        print()
    ...
    if all_passed:
        print("🎉 All smoketests passed! The factor analysis pipeline is working correctly.")
        print()
        print("Next steps:")
