...
Examples:
  ...
  python scripts/cli.py run_daily --freq 5min --price-file data/sample/eod_sample.parquet
    ...
    # run_paper_daily subcommand (OPS-1)
    ...
    # run_paper_range subcommand (OPS-6)
    ...
    # compare_paper_experiments (OPS-7)
...
See scripts/leaderboard.py for more details.
    ...
    # run_news_pipeline subcommand (NEWS v1 MVP)
    ...
    # run_disclosures_pipeline subcommand (DISCL-0)
    ...
    # run_news subcommand (alias for run_news_pipeline)
...
def run_paper_experiment_subcommand(args: argparse.Namespace) -> int:
    """Run A/B paper experiment: paper range with policy and app overrides, write summary under output_root/_experiments/<name>/."""
    import json
    from pathlib import Path
...
def inspect_eod_range_subcommand(args: argparse.Namespace) -> int:
    """Inspect EOD price coverage (same loader as paper runner); print min/max and optional JSON report."""
    from src.assembled_core.data.prices_ingest import load_eod_prices
